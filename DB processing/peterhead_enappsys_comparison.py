...
df.set_index('DateTime', inplace = True)
price_comp = df[['VWA Bid Price', 'VWA Offer Price','Bid Vol @ 3','Bid Vol @ 2','Bid Vol @ 1', 'Offer Vol @ 1', 'Offer Vol @ 2', 'Offer Vol @ 3', 'bid_price-3', 'bid_price-2', 'bid_price-1','offer_price-1', 'offer_price-2','offer_price-3']].merge(wb[['Accepted Offer Price (?/MWh)', 'Accepted Bid Price (?/MWh)']], how = 'outer', left_index = True, right_index = True)
price_comp['bd'] = price_comp['Accepted Bid Price (?/MWh)'] - price_comp['VWA Bid Price']
price_comp['od'] = price_comp['Accepted Offer Price (?/MWh)'] - price_comp['VWA Offer Price']
